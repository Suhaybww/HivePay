    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-col space-y-1">
          ...
          <p className="text-sm font-semibold">First Come, First Serve</p>
          <p className="text-xs text-muted-foreground">
            Members receive payouts in the order they joined the group
          </p>
        </div>
      </CardContent>
    </Card>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-1.5">
                        ...
                        <Badge
                          ...
                          className={`text-xs ${
                            member.payoutOrder === 1 ? "bg-yellow-500" : ""
                          }`}
                        >
              ...
              <div className="flex gap-3 bg-amber-50 border border-amber-200 p-4 rounded-xl">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-amber-700">
                    All members will be charged{" "}
                    <span className="font-semibold">{formattedAmount}</span> immediately upon
