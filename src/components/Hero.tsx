        ...
        <section className="px-2 pt-32 md:px-0">
          <div className="container items-center max-w-6xl px-5 mx-auto space-y-6 text-center">
            ...
            <p className="w-full mx-auto text-base text-left text-gray-500 md:max-w-md sm:text-lg lg:text-2xl md:max-w-3xl md:text-center">
              Join HivePay, a digital platform for secure and automated rotating savings. Whether saving with friends or family, our system ensures trust and transparency every step of the way.
            </p>
